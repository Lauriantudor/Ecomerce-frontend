    ...
    <div className="hidden md:block bg-white dark:bg-zinc-900 border border-stone-200 dark:border-zinc-800 rounded-3xl overflow-hidden shadow-sm dark:shadow-2xl transition-colors duration-300">
      <div className="overflow-x-auto">
        <table className="w-full text-left border-collapse">
          <thead>
            {/* MODIFICAT: border-stone-200, text-stone-500 și bg-stone-100/50 pe light mode */}
            <tr className="border-b border-stone-200 dark:border-zinc-800 text-xs font-bold text-stone-500 dark:text-zinc-400 uppercase tracking-wider bg-stone-100/50 dark:bg-zinc-900/50">
                ...
                >
                  ...
                  <td className="p-5">
                    <select
                      ...
                      // MODIFICAT: bg-white, border-stone-200 / stări adaptive text+bg pe light mode (culori lizibile text-700 și bg-100)
                    ...
                    >
                      {/* MODIFICAT: opțiuni stilizate nativ cu text închis la culoare pe light mode pentru lizibilitatea dropdown-ului sistem */}
                      <option
                        value="pending"
                  ...
                  {/* MODIFICAT: text-stone-600 pe light mode */}
                  <td className="p-5 text-stone-600 dark:text-zinc-300 max-w-xs truncate">
                    {order.address
                      ? `${order.address.city}, ${order.address.streetAddress}`
                      : "Fără adresă"}
                  </td>
