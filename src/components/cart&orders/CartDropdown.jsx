  ...
  return (
    <div className="relative" ref={cartRef}>
      <button
        ...
        className="p-2 text-current hover:text-stone-900 dark:hover:text-white transition-colors relative flex items-center justify-center cursor-pointer rounded-xl hover:bg-stone-50 dark:hover:bg-zinc-900/50"
      ...
      >
        ...
        {totalItems > 0 && (
          <span
            className="absolute top-0.5 right-0.5 bg-emerald-500 text-white font-black text-[9px] w-4 h-4 rounded-full flex items-center justify-center shadow-md"
            aria-hidden="true"
          >
            {totalItems}
          </span>
      ...
      {isOpen && (
        <div className="fixed inset-x-4 top-20 z-50 bg-white dark:bg-zinc-900 border border-stone-200/60 dark:border-zinc-850 rounded-2xl p-4 shadow-xl md:absolute md:top-full md:right-0 md:left-auto md:w-80 md:inset-x-auto md:mt-2 transition-colors duration-300">
          <div className="flex justify-between items-center border-b border-stone-100 dark:border-zinc-800 pb-2.5 mb-3">
            <span className="text-xs font-bold text-stone-600 dark:text-zinc-400 tracking-wide uppercase">
              Coș ({totalItems})
            </span>
          ...
          {!cartItems || cartItems.length === 0 ? (
            <p className="text-stone-600 dark:text-zinc-400 text-xs text-center py-6 font-medium">
            ...
            <>
                    ...
                    >
                      <div className="flex items-center gap-3 flex-1 min-w-0">
                        ...
                        <div className="truncate text-xs">
                          ...
                          <p className="text-stone-600 dark:text-zinc-400 font-medium mt-0.5">
                            {item.quantity} x{" "}
                      ...
                      <button
                        ...
                        className="text-stone-400 hover:text-rose-600 dark:text-zinc-600 dark:hover:text-red-400 p-1.5 rounded-lg text-xs font-bold transition-colors cursor-pointer"
              ...
              <div className="mt-4 pt-3 border-t border-stone-100 dark:border-zinc-800">
                <Link
                  ...
                  className="w-full py-2.5 bg-emerald-600 hover:bg-emerald-700 dark:bg-emerald-500 dark:hover:bg-emerald-400 text-white dark:text-black font-black text-xs rounded-xl text-center block tracking-wider uppercase transition-all shadow-sm"
                >
                  Coșul meu
                </Link>
              </div>
